package com.zedxer.testproject.mapareas;
...
public class MapAreaManager implements GoogleMap.OnMarkerDragListener, GoogleMap.OnMapLongClickListener {
    ...
    public MapAreaWrapper getCircles() {
        return areas;
    }
    /**
   ...
   /* private MarkerMoveResultWithCircle onMarkerMoved(Marker marker) {
    ...
    private MarkerMoveResultWithCircle onMarkerMoved(Marker marker) {
        ...
        result = this.areas.onMarkerMoved(marker);
        if (result != MapAreaWrapper.MarkerMoveResult.none)
            affectedDraggableCircle = this.areas;
